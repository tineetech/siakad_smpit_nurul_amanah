...
<body class="bg-green-600">
    <main class="p-4 bg-white rounded-lg shadow-md my-10 max-w-5xl mx-auto">
        ...
        <form action="{{ route('ppdb.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <h2 class="text-lg font-semibold mt-8">Upload Dokumen</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                {{-- Profile Picture --}}
                <div>
                    <label class="block text-sm font-medium">Foto Calon Siswa <span class="text-red-500">*</span></label>
                    <input type="file" name="profile_picture" required accept="image/*" class="w-full bg-white shadow-sm border p-2 rounded file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                    <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, GIF. Max: 2MB.</p>
                </div>

                {{-- Kartu Keluarga --}}
                <div>
                    <label class="block text-sm font-medium">Kartu Keluarga (KK) <span class="text-red-500">*</span></label>
                    <input type="file" name="kartu_keluarga" required accept="image/*,application/pdf" class="w-full bg-white shadow-sm border p-2 rounded file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                    <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, PDF. Max: 5MB.</p>
                </div>

                {{-- Akta Kelahiran --}}
                <div>
                    <label class="block text-sm font-medium">Akta Kelahiran <span class="text-red-500">*</span></label>
                    <input type="file" name="akta_kelahiran" required accept="image/*,application/pdf" class="w-full bg-white shadow-sm border p-2 rounded file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                    <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, PDF. Max: 5MB.</p>
                </div>

                {{-- Surat Kelulusan --}}
                <div>
                    <label class="block text-sm font-medium">Surat Keterangan Lulus (SKL) / Ijazah <span class="text-red-500">*</span></label>
                    <input type="file" name="surat_kelulusan" required accept="image/*,application/pdf" class="w-full bg-white shadow-sm border p-2 rounded file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                    <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, PDF. Max: 5MB.</p>
                </div>
            </div>
