  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-top">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="mailto:contact@SMPIT NURUL AMANAH.com" class="footer-link">contact@SMPIT NURUL AMANAH.com</a>
          </li>
      ...
      <div class="footer-bottom">
        <p class="copyright">
          Copyright 2022 SMPIT NURUL AMANAH. All Rights Reserved by <a href="#" class="copyright-link">codewithsadee</a>
        </p>
      </div>
